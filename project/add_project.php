            ...
            <h3>Add Project</h3><hr>
                <form action="add_project.php" method="post" id="fileForm" role="form">
                    ...
                    <div class="form-group">   
                        ...
                        <input class="form-control" type="text" name="funding_agency" id = "txt" disabled value="N/A" />
                    </div><br>
                    ...
                    <div class="form-group">   
                        ...
                        <input class="form-control" type="text" name="budget" id = "txt" required placeholder="" />
                    </div>
